...
void alarm_set_power_on(struct timespec new_pwron_time)
{
...
static enum hrtimer_restart alarm_timer_triggered(struct hrtimer *timer)
{
	...
	pr_alarm(INT, "alarm_timer_triggered type %d at %lld (%d)\n",
		base - alarms, ktime_to_ns(now), !!base->first);
...
MODULE_DESCRIPTION("Alarm Driver v1.2");

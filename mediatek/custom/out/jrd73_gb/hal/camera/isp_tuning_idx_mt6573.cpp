...
{
#include "cfg_isp_tuning_idx_0_mt6573.h"    //  main sensor.
#include "cfg_isp_tuning_idx_1_mt6573.h"    //  sub sensor.
};
//
...
getInstance()
{
    static IdxSetMgr_MT6573 singleton;
    static struct link
    {
        link(IdxSetMgr_MT6573& r)
        {

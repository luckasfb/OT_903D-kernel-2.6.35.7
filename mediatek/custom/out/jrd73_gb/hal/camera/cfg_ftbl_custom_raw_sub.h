...
#ifndef _CFG_FTBL_CUSTOM_RAW_SUB_H_
#define _CFG_FTBL_CUSTOM_RAW_SUB_H_


//  1: Enable the custom-specific features of RAW-Sub sensor.
//  0: Disable the custom-specific features of RAW-Sub sensor.
#define CUSTOM_FEATURE_RAW_SUB  1
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    CONFIG_FEATURE(FID_SCENE_MODE, 
        ...
        SCENE_MODE_OFF,       SCENE_MODE_ACTION,      SCENE_MODE_PORTRAIT, 
    ...
    CONFIG_FEATURE(FID_COLOR_EFFECT, 
        ...
        MEFFECT_NEGATIVE,   MEFFECT_SOLARIZE,  MEFFECT_AQUA, 
        MEFFECT_BLACKBOARD, MEFFECT_POSTERIZE, MEFFECT_WHITEBOARD
    )
#endif
    //..........................................................................
#if 0
    ...
    CONFIG_FEATURE(FID_AE_FLICKER, 
        BY_DEFAULT(AE_FLICKER_MODE_60HZ), 
        AE_FLICKER_MODE_60HZ, AE_FLICKER_MODE_50HZ, AE_FLICKER_MODE_OFF
    )
#endif
    //..........................................................................
#if 0
    ...
    //..........................................................................
//------------------------------------------------------------------------------
END_GETFINFO_RAW_SUB()
};  //  namespace NSSub
};  //  namespace NSRAW


#endif // _CFG_FTBL_CUSTOM_RAW_SUB_H_

...
typedef enum                            // ev mode , auto , TV,AV,SV
{
    ...
    LIB3A_AE_MODE_MAX = LIB3A_AE_MODE_BRACKET_AE
} LIB3A_AE_MODE_T;
...
typedef enum                            // enum  for evcompensate
{
    ...
    LIB3A_AE_EV_COMP_n03         =  9,           // EV compensate -0.3
    LIB3A_AE_EV_COMP_n05         = 10,           // EV compensate -0.5
    LIB3A_AE_EV_COMP_n07         = 11,           // EV compensate -0.7
    LIB3A_AE_EV_COMP_n10         = 12,           // EV compensate -1.0
    LIB3A_AE_EV_COMP_n13         = 13,           // EV compensate -1.3
    LIB3A_AE_EV_COMP_n15         = 14,           // EV compensate -1.5
    LIB3A_AE_EV_COMP_n17         = 15,           // EV compensate -1.7
    LIB3A_AE_EV_COMP_n20         = 16,           // EV compensate -2.0
    LIB3A_AE_EV_COMP_TOTAL_NUM,
    LIB3A_AE_EV_COMP_MIN = LIB3A_AE_EV_COMP_00,
    LIB3A_AE_EV_COMP_MAX = LIB3A_AE_EV_COMP_n20
}LIB3A_AE_EVCOMP_T;
...
// AE set frame rate mode
typedef enum
{
    LIB3A_AE_FRAMERATE_MODE_UNSUPPORTED = -1,
    LIB3A_AE_FRAMERATE_MODE_DYNAMIC = 0,
    LIB3A_AE_FRAMERATE_MODE_05FPS = 5,
    LIB3A_AE_FRAMERATE_MODE_15FPS = 15,
    LIB3A_AE_FRAMERATE_MODE_30FPS = 30,

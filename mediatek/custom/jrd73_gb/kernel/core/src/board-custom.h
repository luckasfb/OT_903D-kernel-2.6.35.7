...
#ifndef __ARCH_ARM_MACH_MT6573_CUSTOM_BOARD_H
#define __ARCH_ARM_MACH_MT6573_CUSTOM_BOARD_H
...
#define CONFIG_MTK_COMBO_SDIO_SLOT  (1) /* MSDC1 */
#else
...
#endif /* __ARCH_ARM_MACH_MT6573_CUSTOM_BOARD_H */

...
#ifndef _CAMERA_SENSOR_PARA_OV3640_H
#define _CAMERA_SENSOR_PARA_OV3640_H

	/* STRUCT: SENSOR */
#define OV3640_CAMERA_SENSOR_REG_DEFAULT_VALUE  \
		{\
			/* STRUCT: SENSOR.reg[0] */\
			{\
...
#define OV3640_CAMERA_SENSOR_CCT_DEFAULT_VALUE {{ 0xFFFFFFFF, 0x08 } ,{ 0x0209, 0x0008 } ,{ 0x0207, 0x0008 } ,{ 0x020D, 0x0008 } ,{ 0x020B, 0x0008 }}


#endif//#ifndef _CAMERA_SENSOR_PARA_OV3640_H

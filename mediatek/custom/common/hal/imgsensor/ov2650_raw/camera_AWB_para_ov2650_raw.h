...
#ifndef _CAMERA_AWB_PARA_OV2650_RAW_H
#define _CAMERA_AWB_PARA_OV2650_RAW_H
...
static AWB_PARAM_T g_rAWBParam =
{
	...
	{
	    128, // u4AWBGainOutputScaleUnit: 1.0x = 128 for MT6516
	    511, // u4AWBGainOutputUpperLimit: format 2.7 (9 bit) for MT6516
	    128  // i4RotationMatrixUnit: 1.0x = 128 for MT6516
	},
...
static AWB_STAT_CONFIG_T g_rAWBStatConfig[AWB_MODE_NUM] = 
{ 
	// AWB_MODE_AUTO
    {

...
#ifndef _CAMERA_3A_PARA_OV2650_RAW_H
#define _CAMERA_3A_PARA_OV2650_RAW_H


#include "camera_AE_para_ov2650_raw.h"
#include "camera_AF_para_ov2650_raw.h"
#include "camera_AWB_para_ov2650_raw.h"
...
static AAA_PARAM_T OV2650_RAW_CAMERA_3A_PARA = 
{
    TRUE, // Enable AE
    FALSE, // Enable AF
    TRUE, // Enable AWB
...
static AAA_STAT_CONFIG_PARAM_T OV2650_RAW_CAMERA_3A_STAT_CONFIG_PARAM =
{
    g_rAEPreStatConfig,
    {
	    ...
	    g_rAWBStatConfig[AWB_MODE_GRAYWORLD]
    },
    g_rAFStatConfig   
};

...
#ifndef _CAMERA_SENSOR_PARA_MT9P012_H
#define _CAMERA_SENSOR_PARA_MT9P012_H

	/* STRUCT: SENSOR */
#define MT9P012_CAMERA_SENSOR_REG_DEFAULT_VALUE  \
		{\
			/* STRUCT: SENSOR.reg[0] */\
			{\
...
#endif//#ifndef _CAMERA_SENSOR_PARA_MT9P012_H

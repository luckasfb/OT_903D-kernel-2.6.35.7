...
static void OV3640_set_VGA_mode(void)
{
    ...
    //-------------------------------------------------------------------------------
		...
		OV3640_write_cmos_sensor(0x3366,0x15);		//reserve
              ...
              OV3640_write_cmos_sensor(0x3088, 0x12);
...
{
	pSensorResolution->SensorFullWidth=OV3640_IMAGE_SENSOR_FULL_WIDTH - 2 * IMAGE_SENSOR_START_GRAB_X;  //modify by yanxu
	pSensorResolution->SensorFullHeight=OV3640_IMAGE_SENSOR_FULL_HEIGHT - 2 * IMAGE_SENSOR_START_GRAB_Y;
	pSensorResolution->SensorPreviewWidth=OV3640_IMAGE_SENSOR_PV_WIDTH - 2 * IMAGE_SENSOR_START_GRAB_X;
	pSensorResolution->SensorPreviewHeight=OV3640_IMAGE_SENSOR_PV_HEIGHT - 2 * IMAGE_SENSOR_START_GRAB_Y;
...
{
	pSensorInfo->SensorPreviewResolutionX=OV3640_IMAGE_SENSOR_PV_WIDTH;
	pSensorInfo->SensorPreviewResolutionY=OV3640_IMAGE_SENSOR_PV_HEIGHT;
	pSensorInfo->SensorFullResolutionX=OV3640_IMAGE_SENSOR_FULL_WIDTH;
	pSensorInfo->SensorFullResolutionY=OV3640_IMAGE_SENSOR_FULL_HEIGHT;

...
/*----------------------------------------------------------------------------*/
static ssize_t cm3623_show_i2c(struct device_driver *ddri, char *buf)
{
	ssize_t len = 0;
	u32 base = I2C2_BASE;
...
/*----------------------------------------------------------------------------*/
static ssize_t cm3623_store_i2c(struct device_driver *ddri, const char *buf, size_t count)
{
...
static DRIVER_ATTR(i2c,     S_IWUSR | S_IRUGO, cm3623_show_i2c,   cm3623_store_i2c);
/*----------------------------------------------------------------------------*/

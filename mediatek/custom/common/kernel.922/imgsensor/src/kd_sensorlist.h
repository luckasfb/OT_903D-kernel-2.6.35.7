...
UINT32 HI342_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 HI342SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 OV5647SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 SIV120B_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 MT9T112_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 OV3647_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); 
...
//3M
    ...
    {OV3647_SENSOR_ID, SENSOR_DRVNAME_OV3647_RAW, OV3647_RAW_SensorInit}, 
#endif
#if defined(HM3451_RAW)
    {HM3451_SENSOR_ID, SENSOR_DRVNAME_HM3451_RAW, HM3451SensorInit}, 
#endif
#if defined(MT9T112_YUV)
    {MT9T112_SENSOR_ID, SENSOR_DRVNAME_MT9T112_YUV, MT9T112_YUV_SensorInit}, 
#endif
#if defined(MT9T113_YUV)
    {MT9T113_SENSOR_ID, SENSOR_DRVNAME_MT9T113_YUV, MT9T113_YUV_SensorInit}, 
#endif
#if defined(HI342_YUV)
    {HI342_SENSOR_ID, SENSOR_DRVNAME_HI342_YUV, HI342_YUV_SensorInit}, 
#endif
#if defined(HI342_RAW)
    {HI342_SENSOR_ID, SENSOR_DRVNAME_HI342_RAW, HI342SensorInit}, 
#endif
...
//2M
	...
	{MT9D113_SENSOR_ID, SENSOR_DRVNAME_MT9D113_YUV,MT9D113_YUV_SensorInit},
#endif
#if defined(MT9D115_YUV)
	{MT9D115_SENSOR_ID, SENSOR_DRVNAME_MT9D115_YUV,MT9D115_YUV_SensorInit},
#endif
#if defined(OV2655_YUV)
	{OV2650_SENSOR_ID, SENSOR_DRVNAME_OV2655_YUV,OV2655_YUV_SensorInit},
#endif
#if defined(SID130B_YUV)
    {SID130B_SENSOR_ID, SENSOR_DRVNAME_SID130B_YUV, SID130B_YUV_SensorInit}, 
#endif

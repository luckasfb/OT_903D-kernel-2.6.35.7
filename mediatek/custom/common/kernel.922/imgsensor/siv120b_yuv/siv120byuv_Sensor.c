...
static void SIV120DInitialSetting(void)
{
  ...
  SIV120DWriteCmosSensor(0xAB,0x04); //Brightness        
...
void SIV120DNightMode(kal_bool enable)
{
  ...
  {   /* camera night mode */
    ...
    //SIV120DSetPage(3);
    //SIV120DWriteCmosSensor(0xAB,0x98); //Brightness Control 0x11
  ...
  {   /* camera normal mode */
    ...
    //SIV120DSetPage(1);
    //SIV120DWriteCmosSensor(0x40,0x6C);// 0x7F
    //SIV120DSetPage(3);
    //SIV120DWriteCmosSensor(0xAB,0x98); //0x04 
...
UINT32 SIV120DYUVSetVideoMode(UINT16 u2FrameRate)
{
  ...
  SIV120DCurrentStatus.MinFpsNormal = SIV120D_FPS(30);
  SIV120DCurrentStatus.MinFpsNight =  SIV120DCurrentStatus.MinFpsNormal >> 1; 
  if (u2FrameRate == 30)
  {
    SIV120DCurrentStatus.bNightMode = KAL_FALSE;

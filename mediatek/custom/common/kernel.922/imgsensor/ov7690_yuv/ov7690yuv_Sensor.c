...
static void OV7690InitialSetting(void)
{
  ...
  /* Color Matrix */
  OV7690_write_cmos_sensor(0xbb, 0xac);
  OV7690_write_cmos_sensor(0xbc, 0xae);
  OV7690_write_cmos_sensor(0xbd, 0x02);
  OV7690_write_cmos_sensor(0xbe, 0x1f);
  OV7690_write_cmos_sensor(0xbf, 0x93);
  OV7690_write_cmos_sensor(0xc0, 0xb1);
  OV7690_write_cmos_sensor(0xc1, 0x1A);
  
  /* Edge + Denoise */
  OV7690_write_cmos_sensor(0xb4, 0x06);
  OV7690_write_cmos_sensor(0xb7, 0x07);
  OV7690_write_cmos_sensor(0xb8, 0x06);
  OV7690_write_cmos_sensor(0xb9, 0x00);
  OV7690_write_cmos_sensor(0xba, 0x40);
  
  /* AEC/AGC target */
  /*This only in fixed frame change!*/
  OV7690_write_cmos_sensor(0x24, 0x58);
  OV7690_write_cmos_sensor(0x25, 0x48);
  OV7690_write_cmos_sensor(0x26, 0x92);
  
  /* UV adjust */
  OV7690_write_cmos_sensor(0x5A, 0x74);
  OV7690_write_cmos_sensor(0x5B, 0x9f);
  OV7690_write_cmos_sensor(0x5C, 0x42);
  ...
  OV7690_write_cmos_sensor(0x91, 0x00);
  OV7690_write_cmos_sensor(0x92, 0x86);
  OV7690_write_cmos_sensor(0x93, 0x80);
  OV7690_write_cmos_sensor(0x94, 0x13);
  OV7690_write_cmos_sensor(0x95, 0x1b);
  OV7690_write_cmos_sensor(0x96, 0xff);
  OV7690_write_cmos_sensor(0x97, 0x00);
  OV7690_write_cmos_sensor(0x98, 0x3e);
  OV7690_write_cmos_sensor(0x99, 0x31);
  OV7690_write_cmos_sensor(0x9a, 0x4e);
  //(0x9b, 0x41)20081217 Here adjust AWb, when enter preview, AWb didn't work!
  OV7690_write_cmos_sensor(0x9b, 0x3d);
  ...
  OV7690_write_cmos_sensor(0xa0, 0x6a);
  OV7690_write_cmos_sensor(0xa1, 0x65);
  OV7690_write_cmos_sensor(0xa2, 0x11);

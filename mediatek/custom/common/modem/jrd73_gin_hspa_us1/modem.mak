...
# Generated at Fri Jun  3 15:47:51 2011
...
BOARD_VER         =  JRD73_GIN_MODEM_BB # Baseband main board description, SHOULD BE ONE OF THE FOLLOWINGS
...
RF_MODULE         =  JRD73_GIN_MODEM_MT6162      # SKY74045, AERO, FOUNTAIN2, SPRING,
                                 # MT6129D, AERO1PLUS
...
# ------------------------------ HW and Project
# ------------------------------ LCD
LCD_MODULE        =  JRD73_GIN_MODEM_LCM  # Based on the LCM solutions (even multiple LCM modules for this project)
...
FLAVOR = ANDROID_GEMINI_OH    # FLAVOR = NONE/$(FLAVOR)
...
UMTS_RF_MODULE    =  JRD73_GIN_MODEM_MT6162
...
MONITOR_PAGE_DURING_TRANSFER = SELF_AND_CELL_PCH    # NONE = Monitor neigher self nor peer paging
                                                    # SELF_ONLY = Monitor self CS PCH during PKT mode
                                                    # SELF_AND_CELL_PCH = Monitor self CS PCH during PKT mode and peer paging in CELL_PCH
...
# *************************************************************************
COM_DEFS_FOR_JRD73_GIN_MODEM_LCM  = JRD73_GIN_MODEM_LCM TFT_MAINLCD
COM_DEFS_FOR_JRD73_GIN_MODEM_MT6162  = MT6162_RF JRD73_GIN_MODEM_MT6162
...
CUSTOM_OPTION += __SMART_PAGING__ __SATCE__

CUSTOM_OPTION += __CSCB_ALL_LANGUAGE_ON__

CUSTOM_OPTION += __GIN_SVN_SETTING__ __R_H_NOT_COMBINED_BY_CUSTOM__

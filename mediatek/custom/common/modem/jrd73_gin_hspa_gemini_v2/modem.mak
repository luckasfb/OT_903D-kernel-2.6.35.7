...
# Generated at Mon Sep 26 17:32:49 2011
...
BOARD_VER         =  JRD73_GIN_MODEM_GEMINI2_BB # Baseband main board description, SHOULD BE ONE OF THE FOLLOWINGS
...
RF_MODULE         =  JRD73_GIN_MODEM_GEMINI2_MT6162      # SKY74045, AERO, FOUNTAIN2, SPRING,
                                 # MT6129D, AERO1PLUS
...
# ------------------------------ HW and Project
# ------------------------------ LCD
LCD_MODULE        =  JRD73_GIN_MODEM_GEMINI2_LCM  # Based on the LCM solutions (even multiple LCM modules for this project)
...
PUSH_MAIL = NONE    # 139: turn on this feature and with flyfot 139 solution, NONE: turn off this feature
...
SECURE_JTAG_ENABLE = TRUE    # TRUE,FALSE
...
# ------------------------------ Security
# ------------------------------ Modem
GPRS_MAX_PDP_SUPPORT    = 3      # 2, 3, 4, 5, 6 or 7  Maximum simultaneous PDP contexts (2~7)
...
# ------------------------------ TD-SCDMA
# ------------------------------ File system and System service
KAL_TRACE_OUTPUT = ON    # ON (Default, Enable Trace Output)
                         # OFF (Disable Trace)
                         # DEBUG_ON: (For Build lib purpose, PM cannnot choose it)
...
IPV6_PDP_SUPPORT = TRUE     # TRUE : Enable this feature
...
#[Non-modifiable]# ------------------------------ Connectivity
L1_GPS_REF_TIME_SUPPORT = TRUE    # TRUE : Support L1 GPS timing sync.feature
                                   # FALSE : Not support L1 GPS timing sync.feature
...
AGPS_UP_CP_CONFLICT_HANDLING_SUPPORT = TRUE    # TRUE : Support UP CP conflict handling feature
                                                # FALSE : Not support UP CP conflict handling feature

AGPS_CP_SIB15_SUPPORT = TRUE    # TRUE : Support SIB15 collection feature
                                 # FALSE : Not support SIB15 collection feature
...
BES_LOUDNESS_SUPPORT = NONE  # NONE, LOUDSPEAKER, LOUDSPEAKER_RINGTONE
...
UMTS_RF_MODULE    =  JRD73_GIN_MODEM_GEMINI2_MT6162
...
SP_VIDEO_CALL_SUPPORT   = TRUE    #  TRUE or FALSE
...
CARD_DOWNLOAD = NONE    # NONE: disable card DL
                        ...
                        # FILESYSTEM_ON_CARD: Enable Card DL, the image can be copied into card as a file. In other words, the download package can be directly copied into T-flash by Windows
...
PHB_FDN_ENTRY = 50    #  Phonebook FDN entry count in SIM: 32, 50
...
# *************************************************************************
RELEASE_PACKAGE = REL_CR_L4_hspa # REL_CR_MMI_GPRS, REL_CR_MMI_GSM, REL_CR_L4_GPRS, REL_CR_L4_GSM
...
COM_DEFS_FOR_JRD73_GIN_MODEM_GEMINI2_MT6162  = MT6162_RF JRD73_GIN_MODEM_GEMINI2_MT6162
COM_DEFS_FOR_JRD73_GIN_MODEM_GEMINI2_LCM = JRD73_GIN_MODEM_GEMINI2_LCM
...
CUSTOM_OPTION += __SMART_PAGING__ __SATCE__ __CSCB_ALL_CHANNEL_ON__

CUSTOM_OPTION += __CSCB_ALL_LANGUAGE_ON__ __SAT_PROVIDE_CELL_IN_SIM__

CUSTOM_OPTION += __SP_GEMINI_3G_SWITCH__ __MM_HPPLMN_1ST_ATTEMPT_ENHANCE__

CUSTOM_OPTION += __MONITOR_PAGE_DURING_TRANSFER__

CUSTOM_OPTION += __GIN_SVN_SETTING__ __R_H_NOT_COMBINED_BY_CUSTOM__ __MM_TRY_ABNORMAL_LAI_ONCE_MORE__ __DOCOMO_IOT_CB__

CUSTOM_OPTION += __SIM_JSR1777_APDU__ __CSIM__  __SIM_JSR177_APDU__
...
EXISTED_CUS_REL_TRACE_DEFS += ps\l4\smu\include\smu_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += interface\event_info\event_info_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\l4\smsal\include\smsal_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\l4\rac\include\rac_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\mm2\common\include\mm_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\l4\tcm\include\tcm_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\l4\include\atci_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += hal\audio\src\v2\inc\l1sp_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\cmux\include\cmux_trc.h 
EXISTED_CUS_REL_TRACE_DEFS += ps\ups\include\ups_trc.h 

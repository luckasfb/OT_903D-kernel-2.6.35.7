...
MODEM_BOARD_VER         =  JRD73_GIN_MODEM_BB # Baseband main board description, SHOULD BE ONE OF THE FOLLOWINGS
...
MODEM_RF_MODULE         =  JRD73_GIN_MODEM_MT6162      # SKY74045, AERO, FOUNTAIN2, SPRING,
MODEM_PHONE_TYPE 		=  BAR      # BAR, CLAMSHELL, SLIDE
MODEM_VENDOR = NONE     # NONE: non-vendor project
MODEM_LCD_MODULE        =  JRD73_GIN_MODEM_LCM  # Based on the LCM solutions (even multiple LCM modules for this project)
...
MODEM_UMTS_BAND_II   = FALSE  # TRUE, FALSE
...
MODEM_UMTS_BAND_VIII = FALSE  # TRUE, FALSE
...
MODEM_OTP_SUPPORT         = TRUE      # TRUE, FALSE
...
MODEM_FLAVOR = ANDROID_GEMINI_OH    # FLAVOR = NONE/$(FLAVOR)
...
MODEM_UMTS_RF_MODULE    =  JRD73_GIN_MODEM_MT6162
...
MODEM_PS_HANDOVER = TRUE    # TRUE, FALSE
...
MODEM_NVRAM_COMPRESS_SUPPORT = FALSE    # TRUE,FALSE
...
MODEM_MONITOR_PAGE_DURING_TRANSFER = SELF_AND_CELL_PCH    # NONE = Monitor neigher self nor peer paging
...
MODEM_COM_DEFS_FOR_JRD73_GIN_MODEM_LCM  = JRD73_GIN_MODEM_LCM TFT_MAINLCD
MODEM_COM_DEFS_FOR_JRD73_GIN_MODEM_MT6162  = MT6162_RF JRD73_GIN_MODEM_MT6162

...
#ifndef __MT6573_DOWNLOAD_H
#define __MT6573_DOWNLOAD_H
...
#define DM_CAL_CKSM_FROM_NAND_FLASH     0       // disable SECURE_IMG_ANTICLONE first
...
typedef enum _DM_ERR_CODE
{
    ...
    DM_ERR_EXCEED_BOUNDARY = 8, /* image download boundary check fail */
...
{
    U32 pattern;                                        /* pattern to recgnize preloader info packet */
...
*  20100719 : Shu-Hsin add verification command
**************************************************************************/
...
#endif    
    U32 pkt_size;                   /* packet size per transmition ( page + spare ) */
} DM_EXT_IMG_INFO;

#pragma pack(4)
typedef struct _DM_EXT_IMAGE_INFO_PACKET
{
    U32 pattern;                    /* pattern to recgnize image info packet */
...
//* modification history :
//*
//* 20100429  : (1) add new authentication file verification response
//*
//******************************************************
/**************************************************************************
...
#define DM_STR_LOCKED_REQ               "LOCKED"        /* Respond lock notification to tool */

#define DM_STR_VERIFY_PASS      "VERIFYOK"      /* Authentication File and Image Patch Ack */
#define DM_STR_VERIFY_FAIL      "VERIFYFAIL"    /* Authentication File and Image Patch Ack */
...
#define DM_SZ_IMG_HPBUF         10      /* max handshake protocol buffer size */
...
//* modification history :
//*
//* 20100429  : (1) add new stage "DM_STATUS_VERIFY" 
//*                             (2) this stage is to verify Flash Tool's authentication file
//*
//******************************************************
typedef enum
{
    DM_STATUS_NONE = 0,
    DM_STATUS_START = 1,        /* download mode status is just started */
...
extern void transmission_main (void);

#endif /* __MT6573_DOWNLOAD_H */

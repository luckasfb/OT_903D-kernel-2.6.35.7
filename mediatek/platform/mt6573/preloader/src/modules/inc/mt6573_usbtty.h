...
extern int mt6573_usbtty_tstc (void);
extern int mt6573_usbtty_getc (void);
extern int mt6573_usbtty_getcn (int count, char *buf);
extern void mt6573_usbtty_putc (const char c, int flush);
extern void mt6573_usbtty_putcn (int count, char *buf, int flush);
extern void mt6573_usbtty_puts (const char *str);
extern int mt6573_usbtty_query_data_size (void);
extern bool mt6573_usb_connected (void);
extern bool mt6573_usb_connect (void);
extern void mt6573_usb_disconnect (void);

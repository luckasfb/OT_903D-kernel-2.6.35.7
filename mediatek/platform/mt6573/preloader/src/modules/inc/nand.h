...
#define BMT_DAT_BUFFER              (NAND_BUFFER_START)
#define BMT_DAT_BUFFER_SIZE         (MAX_MAIN_SIZE + MAX_SPAR_SIZE)

#define PMT_DAT_BUFFER              (BMT_DAT_BUFFER + BMT_DAT_BUFFER_SIZE)
#define PMT_DAT_BUFFER_SIZE         (MAX_MAIN_SIZE + MAX_SPAR_SIZE)

#define PMT_READ_BUFFER             (PMT_DAT_BUFFER + PMT_DAT_BUFFER_SIZE)
...
extern int mt6516_nand_init (void);
extern bool mt6516_nand_reset (void);
extern void mt6516_nand_reset_descriptor (void);

extern int mt6516_nand_write_page_hwecc (unsigned int logical_addr,
                                         char *buf);
extern int mt6516_nand_read_page_hwecc (unsigned int logical_addr, char *buf);
extern int mt6516_nand_erase (unsigned int logical_addr);

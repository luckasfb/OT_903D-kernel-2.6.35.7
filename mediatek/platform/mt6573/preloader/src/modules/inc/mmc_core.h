...
extern void mmc_hard_reset(void);
...
extern unsigned long mmc_block_read(int dev_num, unsigned long blknr, u32 blkcnt, unsigned long *dst);
extern unsigned long mmc_block_write(int dev_num, unsigned long blknr, u32 blkcnt, unsigned long *src);
...
extern int mmc_erase_start(struct mmc_card *card, u32 addr);
extern int mmc_erase_end(struct mmc_card *card, u32 addr);

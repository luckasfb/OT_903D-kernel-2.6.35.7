...
#define MSDC_PIO_DATA_MODE              (0)
#define MSDC_DMA_DATA_MODE              (1)
...
extern void msdc_config_pin(struct mmc_host *host, int mode);
extern void msdc_config_bus(struct mmc_host *host, u32 width);
extern void msdc_soft_reset(struct mmc_host *host);
extern void msdc_hard_reset(void);
...
extern void msdc_clear_fifo(struct mmc_host *host);
...
extern int msdc_pio_write(struct mmc_host *host, u32 *ptr, u32 size);
extern int msdc_pio_read(struct mmc_host *host, u32 *ptr, u32 size);
extern void msdc_set_fifothd(struct mmc_host *host, int threshold);

...
/* import customer configuration format */
#include "sec_cust.h"

/******************************************************************************
 * SECURE CFG READ SIZE
 ******************************************************************************/
#define SEC_CFG_READ_SIZE               (0x2000)
...
extern U32 seclib_image_verify (U8* image_name, BOOL bMsg);
...
extern U32 seclib_init ( CUSTOM_SEC_CFG *cust_cfg, U8* sec_cfg_cipher_data, U32 sec_cfg_read_size, BOOL bMsg);

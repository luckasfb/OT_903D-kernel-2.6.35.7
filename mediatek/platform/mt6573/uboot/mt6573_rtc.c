...
bool rtc_boot_check(void)
{
	...
	/*printf("irqsta = 0x%x, pdn1 = 0x%x, pdn2 = 0x%x, spar1 = 0x%x\n",
...
{
	printf("mt6573_power_off\n");

	rtc_bbpu_power_down();

	while (1) {
		printf("mt6573_power_off : check charger\n");
...
//MODULE_DESCRIPTION("MT6573 RTC U-Boot Driver v1.3");

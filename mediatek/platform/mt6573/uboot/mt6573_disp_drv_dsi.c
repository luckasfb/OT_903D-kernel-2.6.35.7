...
#ifdef CONFIG_FB_MT6516_SIMULATE_MULTIPLE_RESOLUTIONS_ON_OPPO
    UINT32 tmpFbPitchInBytes = 480 * get_dsi_tmp_buffer_bpp();
    UINT32 tmpFbSizeInBytes  = tmpFbPitchInBytes * 800;
#else	
    UINT32 tmpFbPitchInBytes = DISP_GetScreenWidth() * get_dsi_tmp_buffer_bpp();

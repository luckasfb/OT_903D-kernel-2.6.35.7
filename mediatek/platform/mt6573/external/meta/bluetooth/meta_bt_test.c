...
int main(int argc, const char** argv)
{
    ...
    req.op = BT_OP_HCI_SEND_COMMAND;
    req.cmd.hci.opcode = 0xfc72;
    req.cmd.hci.len = 1;
    req.cmd.hci.cmd[0] = 0x23;
    META_BT_OP(&req, NULL, 0);
    ...
    /* 1,4,5,33,8B,9E,30,A */
    req.op = BT_OP_HCI_SEND_COMMAND;
    req.cmd.hci.opcode = 0x0401;
    req.cmd.hci.len = 5;
    req.cmd.hci.cmd[0] = 0x33;
    req.cmd.hci.cmd[1] = 0x8B;
    req.cmd.hci.cmd[2] = 0x9E;
    req.cmd.hci.cmd[3] = 0x05;
    req.cmd.hci.cmd[4] = 0x0A;
    META_BT_OP(&req, NULL, 0);

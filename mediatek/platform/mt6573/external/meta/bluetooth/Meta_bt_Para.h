...
typedef union {
	BT_HCI_CMD	  	hci;
	BT_HCI_BUFFER  	buf;
	BT_HCI_TX_PURE_TEST txpuretest;
	unsigned int  dummy;
} BT_CMD;
...
typedef union {
	...
	BT_HCI_TX_PURE_TEST_STAT 	txstat;
	BT_HCI_RX_PURE_TEST_STAT 	rxstat;
	BT_HCI_TX_PURE_TEST_STAT_V2  txstat_v2;
	BT_HCI_RX_PURE_TEST_STAT_V2  rxstat_v2;
	unsigned int  dummy;
} BT_RESULT;

...
bool FT_ACDK_CCT_V2_OP_AE_GET_AUTO_EXPO_PARA(const FT_CCT_REQ* pREQ,FT_CCT_CNF* pCNF,char** pBuff)
{
	...
	ACDK_LOGD("[CCAP]:u4AfeGain;:%d!",MSDK_AE_get_expo.u4AfeGain);
...
bool FT_ACDK_CCT_V2_OP_AWB_GET_NVRAM_CCM(const FT_CCT_REQ* pREQ,FT_CCT_CNF* pCNF,char** pBuff)
{
    ...
    ACDK_LOGD("RESERVED0 0x%02X", ccm.RESERVED0);
    ACDK_LOGD("M11 M12 M13 : 0x%02X 0x%02X 0x%02X", ccm.M11, ccm.M12, ccm.M13);
    ACDK_LOGD("RESERVED1 0x%02X", ccm.RESERVED1);
    ACDK_LOGD("M21 M22 M23 : 0x%02X 0x%02X 0x%02X", ccm.M21, ccm.M22, ccm.M23);
    ACDK_LOGD("RESERVED2 0x%02X", ccm.RESERVED2);
    ACDK_LOGD("M31 M32 M33 : 0x%02X 0x%02X 0x%02X", ccm.M31, ccm.M32, ccm.M33);
...
bool FT_ACDK_CCT_V2_OP_AWB_SET_NVRAM_CCM(const FT_CCT_REQ* pREQ,FT_CCT_CNF* pCNF,char** pBuff)
{
	...
	ACDK_LOGD("0x%02x, 0x%02x, 0x%02x", inCCM.ccm.M11, inCCM.ccm.M12, inCCM.ccm.M13); 
    ACDK_LOGD("0x%02x, 0x%02x, 0x%02x", inCCM.ccm.M21, inCCM.ccm.M22, inCCM.ccm.M23); 
    ACDK_LOGD("0x%02x, 0x%02x, 0x%02x", inCCM.ccm.M31, inCCM.ccm.M32, inCCM.ccm.M33);
...
bool FT_ACDK_CCT_V2_OP_AE_APPLY_EXPO_INFO(const FT_CCT_REQ* pREQ,FT_CCT_CNF* pCNF,char** pBuff)
{
  ...
  ACDK_LOGD("AFE Gain:%d", rAEExpPara.u4AfeGain); 

...
typedef struct
{
    unsigned PLL_EN                	: 1;
		...
		unsigned DSI_BIST_HS_BIAS_EN   	: 1;
		unsigned DSI_EXT_CK_SEL        	: 1;
		unsigned DSI_CK_INV            	: 1;
    unsigned rsv_9                 	: 7;
    unsigned rsv_16									: 16;    	    	
...
typedef struct
{
    unsigned RG_PLL_BIC      : 3;
    unsigned RG_PLL_BC       : 1;
    unsigned RG_PLL_BIR      : 4;
    unsigned RG_PLL_BP       : 4;
    unsigned RG_PLL_BR       : 3;
    unsigned rsv_15          : 1;
    unsigned rsv_16          : 16;    	    	
...
typedef struct
{
    unsigned RG_PLL_KVSEL						: 2;
    unsigned RG_PLL_PRDIV						: 2;
    unsigned RG_PLL_VCOCAL_CKCTL		: 2;
    unsigned RG_PLL_LKV_EN					: 1;
    unsigned RG_PLL_FB_DIV2					: 1;
    unsigned RG_PLL_CDIV 						: 3;
    unsigned RG_PLL_RT_ENB					: 1;
    unsigned RG_PLL_FBCLK_MEN				: 1;
    unsigned RG_PLL_REFCLK_MEN			: 1;
    unsigned RG_PLL_AUTOK_EN				: 1;
    unsigned RG_PLL_PODIV2_EN				: 1;    	
    unsigned rsv_16          				: 16;    	
} DSI_PHY_REG_ANACON3, *PDSI_PHY_REG_ANACON3;
...
typedef struct
{
    ...
    DSI_PHY_REG_ANACON3 ANACON3;        // 000C
...
STATIC_ASSERT(0x0010 == sizeof(DSI_PHY_REGS));

...
#ifndef __MT6573_UART_H__
#define __MT6573_UART_H__
...
#define UART_NR                     4
/*---------------------------------------------------------------------------*/
#define MT6573_SYSCLK_65            65000000
#define MT6573_SYSCLK_58_5          58500000
#define MT6573_SYSCLK_52            52000000
#define MT6573_SYSCLK_26            26000000
#define MT6573_SYSCLK_13            13000000
#define MT6573_SYSCLK_6144          61440000
#define MT6573_SYSCLK_3072          30720000
#define MT6573_SYSCLK_1536          15360000
/*---------------------------------------------------------------------------*/
#if !defined(CONFIG_ARCH_MT6573)
#error NOT 6573 Platform!!
#elif defined(CONFIG_MT6573_FPGA)
#define UART_SYSCLK                 5000000
#else
#define UART_SYSCLK                 MT6573_SYSCLK_6144
#endif
/*---------------------------------------------------------------------------*/
...
do {    \
    if ((DBG_EVT_##evt) & mt6573_uart_evt_mask[uart->nport]) { \
        const char *s = #evt;                                  \
...
/*---------------------------------------------------------------------------*/
#define UART_DEBUG_EVT(evt)    ((evt) & mt6573_uart_evt_mask[uart->nport])
/*---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*/
struct mt6573_uart_vfifo
{
    struct mt6573_uart_dma      *dma;    /* vfifo dma owner */    
    ...
    struct mt6573_uart_buf      dbg[C_UART_DEBUG_BUF_NUM];
    struct mt6573_uart_buf      *cur;
    int                         dbgidx;
};
/*---------------------------------------------------------------------------*/
struct mt6573_uart_dma {
...
struct mt6573_uart
{
    ...
    struct mt6573_uart_dma dma_tx;
    struct mt6573_uart_dma dma_rx;
    struct mt6573_uart_vfifo *tx_vfifo;
    struct mt6573_uart_vfifo *rx_vfifo;

#ifdef ENABLE_DEBUG
    struct mt6573_uart_regs *debug;
#endif
    struct mt6573_uart_setting* setting;

    unsigned int (*write_allow)(struct mt6573_uart *uart);
    unsigned int (*read_allow)(struct mt6573_uart *uart);
    void         (*write_byte)(struct mt6573_uart *uart, unsigned int byte);
    unsigned int (*read_byte)(struct mt6573_uart *uart);
    unsigned int (*read_status)(struct mt6573_uart *uart);
};
/*---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*/
struct mt6573_dma_vfifo_reg {
    struct mt6573_vfifo_tx_reg tx;
    struct mt6573_vfifo_rx_reg rx;
};
/*---------------------------------------------------------------------------*/
#endif /* MT6573_UART_H */

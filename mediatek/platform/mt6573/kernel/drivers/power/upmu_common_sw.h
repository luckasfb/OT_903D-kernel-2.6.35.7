...
extern void upmu_ldo_vaudp_stb_force(upmu_ldo_list_enum ldo, kal_bool enable);
extern void upmu_ldo_vaudn_ck_mode(upmu_ldo_list_enum ldo, kal_bool enable);
extern void upmu_ldo_vaudn_ck_force(upmu_ldo_list_enum ldo, kal_bool enable);
...
extern void upmu_cs_vth(upmu_chr_list_enum chr, upmu_chr_current_enum current_val);

...
#if 0
    // MT6516 TVC only support RGB565 format
    // Force use RGB565 intermediate buffer format before
    // dpi_tvout_enable() TODO(BL) is finished
    //
    // Remember to sync. this code with uboot
    //

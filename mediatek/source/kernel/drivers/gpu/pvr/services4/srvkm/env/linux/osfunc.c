        ...
        )
{
    ...
    if(!psDeviceNode)
    {
        ...
        printk(KERN_ERR "PVR_K: DeviceISRWrapper: invalid params\n");
        goto out;
    }
                                    ...
                                    IMG_VOID *pvDeviceNode)
{
    ...
    if (psEnvData->bLISRInstalled)
    {
        ...
        printk(KERN_ERR "PVR_K: OSInstallDeviceLISR: An ISR has already been installed: IRQ %d cookie %p\n", psEnvData->ui32IRQ, psEnvData->pvISRCookie);
    ...
    printk(KERN_WARNING "PVR_K: Installing device LISR %s on IRQ %d with cookie %p\n", pszISRName, ui32Irq, pvDeviceNode);
        ...
        , pszISRName, pvDeviceNode))
    {
        ...
        printk(KERN_ERR "PVR_K: OSInstallDeviceLISR: Couldn't install device LISR on IRQ %d\n", ui32Irq);

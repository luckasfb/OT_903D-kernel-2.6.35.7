...
static void draw_progress_locked()
{
    ...
    // Adjust the progress bar location 
...
static void draw_screen_locked(void)
{
    ...
    if (show_text) {
        ...
        // Modify the text collor
        gr_color(240, 255, 240, 255);
            ...
            if (ev.type == EV_SYN) {
                ...
                if (ev.code == REL_Y) {
                    ...
                    if (rel_sum > 3) {
                        fake_key = 1;
                        ev.type = EV_KEY;
                        //ev.code = RECOVERY_KEY_DOWN;
                        ev.code = RECOVERY_KEY_VOLDOWN;
                        ev.value = 1;
                        rel_sum = 0;
                    } else if (rel_sum < -3) {
                        fake_key = 1;
                        ev.type = EV_KEY;
                        //ev.code = RECOVERY_KEY_UP;
                        ev.code = RECOVERY_KEY_VOLUP;
                        ev.value = 1;
                        rel_sum = 0;
                    }
                }
